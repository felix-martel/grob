...
from typing import Callable, Dict, List, NewType, Optional, Pattern, TypeAlias, Union
...
Group: TypeAlias = Dict[TagName, Union[Path, List[Path], None]]
"""Represents a group of files that share the same key, broken down by tag."""

TagSpec: TypeAlias = Union[str, Pattern, Callable[[Path], str]]
...
Parser: TypeAlias = Callable[[Path], Optional[Dict[KeyPart, str]]]
